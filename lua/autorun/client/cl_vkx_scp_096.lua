...
hook.Add( "Think", "vkxscp096:trigger", function()
	...
	--  homemade cooldown
	if guthscp.configs.vkxscp096.detection_method == guthscp.DETECTION_METHODS.CLIENTSIDE and not ( guthscp.configs.vkxscp096.ignore_scps and guthscp.is_scp( ply ) ) and not guthscp.isSCP096( ply ) then
		local dt = FrameTime()
